...
<html>
    ...
    <center><h1 style="background-color: grey;color:white;opacity:0.9;">Search Book</h1></center>
    <a href="books.jsp"> <i style="color:white; font-size: 30px; position: absolute; left: 40px;" class="fa fa-chevron-left" aria-hidden="true"></i></a>
    <form name="addbook" METHOD = “POST” ACTION = "lib">
        ...
        <ul>
            ...
            <!--            <li>
                            ...
                            <select>
                                <option>BookId <input type="text" id="bookid" name="bookid" placeholder="0000"></option>
                                <option>ISBNumber <input type="text" id="bookid" name="bookid" placeholder="0000"></option>  
                                <option>Author <input type="text" id="bookid" name="bookid" placeholder="0000"></option>  
                                <option>Title<input type="text" id="bookid" name="bookid" placeholder="0000"></option>  
                            </select>
                        </li>-->
            <li>
